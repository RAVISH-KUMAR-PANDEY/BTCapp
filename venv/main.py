...
#constants.........................................
# alpha Vantage : 7KWFIFE9DYZWXCSM data = urllib.request.urlopen('https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_WEEKLY&symbol=BTC&market=USD&apikey=7KWFIFE9DYZWXCSM').read()
            ...
            if dataPace == 'tick':
                try:
                    if exchange == 'Btc-e':
                        ...
                        volume = data["amount"]
                        a.clear()
                        a.plot_date(buysDates, buys["price"], darkColor, label="buys")
                        a.plot_date(sellsDates, sells["price"], lightColor, label="sells")
                    ...
                    if exchange == "Bitstamp":
                        ...
                        a.clear()
                        #a.plot_date(buysDates, buys["price"], darkColor, label="buys")
                        a.plot_date(dateStamps[:30], data["price"][:30], lightColor, label="sells")
